                    ...
                    <div class="data-rowX">
                        ...
                        <div class="center-column">
                            <div class="data-row">
                                ...
                                <input type="text" class="value" name="nombres"
                            ...
                            <div class="data-row">
                                ...
                                <input type="text" class="value" name="nmr_tel"
                                    value="<?php echo $usuario['nmr_tel']; ?>">
                            </div>
                            <div class="data-row">
                                <span class="label">Fecha nacimiento:</span>
                                <input type="text" class="value" name="fch_nac"
                                    value="<?php echo $usuario['fch_nac']; ?>">
                            </div>
                        </div>
                        <div class="right-column">
                            <div class="data-row">
                                <span class="label">Dirección:</span>
                                <input type="text" class="value" name="direccion"
                                    value="<?php echo $usuario['direccion']; ?>">
                            </div>
                            <div class="data-row">
                                <span class="label">Estado Civil:</span>
                                <input type="text" class="value" name="est_cvl"
                                    value="<?php echo $usuario['est_cvl']; ?>">
                            </div>
                            <div class="data-row">
                                <span class="label">Ciudad:</span>
                                <input type="text" class="value" name="ciudad"
                    ...
                    <div class="data-rowX">
                        <div class="left-column">
                            ...
                            <div class="data-row">
                                ...
                                <input type="text" class="value" name="cll_prn"
                                    value="<?php echo $usuario_dmc['cll_prn']; ?>">
                            </div>
                            <div class="data-row">
                                <span class="label">Calle Secundaria:</span>
                                <input type="text" class="value" name="cll_scn"
                                    value="<?php echo $usuario_dmc['cll_scn']; ?>">
                            </div>
                            <div class="data-row">
                                <span class="label">Ciudad:</span>
                                <input type="text" class="value" name="ciudad"
                        ...
                        <div class="right-column">
                            ...
                            <div class="data-row">
                                ...
                                <input type="text" class="value" name="provincia"
                                    value="<?php echo $usuario['provincia']; ?>">
                            </div>
                            <div class="data-row">
                                <span class="label">Código Postal:</span>
                                <input type="text" class="value" name="cdg_pst"
                                    value="<?php echo $usuario_dmc['cdg_pst']; ?>">
                            </div>
                            <div class="data-row">
                                <span class="label">Teléfono de contacto:</span>
                                <input type="text" class="value" name="tlf_cnt"
                                    value="<?php echo $usuario_dmc['tlf_cnt']; ?>">
                            </div>
                            <div class="data-row">
                                <span class="label">Referencia de domicilio:</span>
                                <input type="text" class="value" name="referencia"
                                    value="<?php echo $usuario_dmc['referencia']; ?>">
                            </div>
                        </div>
                    </div>
                    <button type="submit" class="btn-guardar">Guardar</button>
